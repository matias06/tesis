...
public function setdescripcion_estado_reserva ($arg_descripcion_estado_reserva){
	...
	public function modificarReservas(){
		$ModCatReserva = $this->insertarRegistros
		("UPDATE reserva SET id_servicio='".$this->id_servicio."',
		 descripcion_problema='".$this->descripcion_problema."',
		  fecha='".$this->fechaReserva."', id_estado_reserva='".$this->id_estado_reserva."',
			 id_hora='".$this->horaReserva."' WHERE id_reserva='".$this->id_reserva."'");
		return $ModCatReserva;

	}

	public function eliminarReservas(){
		$eliminarReserva = $this->insertarRegistros
			("DELETE FROM reserva WHERE id_reserva='".$this->id_reserva."';");
