                     ...
                     <script>
                            ...
                            <script>
                             ...
                             $("#formModificarServicio").submit(function(){//captura cuando se envia el formulario
                                ...
                                if($("#txt_descripcionServicio_modificar").val()==""){
                                ...
                                function eliminarServicio(id){
                                    // alert(id);
                                     swal({
                                        ...
                                        confirmButtonText: "Desea eliminar!",
                                     ...
                                     $.ajax({//realiza el envio del formulario pero por ajax para no tener que recargar pagina
                                        ...
                                        success:function(respuesta){
                                          if(respuesta==1){
                                            ...
                                            swal("No se puede eliminar servicio, favor verifique si tiene datos asociadas a la cuenta.", "", "error");
                                          }
                                       }
                                    });
                                            } else {
