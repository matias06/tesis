                                            ...
                                            <label for="region">Region</label>
                                                 <select class="form-control" name="region" id="region">
                                                    <?php
                                                        ...
                                                        foreach($filasRegion as $region){
                                                            echo '<option value="'.$region['id_region'].'" >'.$region['nombre_region'].'</option>';
                                                        }
                ...
                //INICIO SCRIPT PARA CARGAR TABLA Y PAGINADA
                  ...
                  function listarTabla(){
                      ...
                      $.ajax({
                        ...
                        data:"mant=6&func=4&buscar="+busqueda+"&pag="+pagina+"&cantidadReg="+$("#cmb_cantidadRegistros").val(),
                        success:function(respuesta){
