...
<br>
            ...
            <div class="container">
                  <div class="row">
                    <div id="contenedorProveedor" class="tablaGeneral"></div><!-- DIV DONDE SE CARGA LA TABLA-->
                    ...
                    //INICIO SCRIPT PARA CARGAR TABLA Y PAGINADA
                      ...
                      function listarTabla(){
                          ...
                          $.ajax({
                            ...
                            data:"mant=3&prov=5&buscar="+busqueda+"&pag="+pagina+"&cantidadReg="+$("#cmb_cantidadRegistros").val(),
                            success:function(respuesta){
                                  $("#contenedorProveedor").html(respuesta);
                            }
                          });
